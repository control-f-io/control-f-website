...
# that page and that catalogue to write the English edition; build-site.py
# reads both editions to write the pages that actually ship at the root. Run
# them the other way round and you publish yesterday's archive in English.
#
